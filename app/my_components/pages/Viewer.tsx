  ...
  return (
    <div className="min-h-screen w-screen flex justify-center items-center">
      <div className="mt-16 bg-white dark:bg-zinc-950 w-full relative ">
        ...
        <div className="max-sm:hidden z-20 "><CirclePlus onClick={increasewidth} className=" hover:cursor-pointer"  /><CircleMinus onClick={decreasewidth} className="text-4xl hover:cursor-pointer"  /></div>
      </div>
    </div>
  );
 } catch (error) {
